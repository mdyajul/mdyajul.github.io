  ...
  return (
    <Container maxW={"7xl"} p="12" id="Projects">
      ...
      >
        <GridItem>
          <Card
            img={"https://i.ibb.co/tXvbR7Y/Screenshot-216.png"}
            tag={["Collaborative", "E-Commerce"]}
            tsTags={["HTML", "CSS", "JavaScript", "ES-6", "LocalStorage"]}
            heading={"Green House Clone"}
            content={
              "This is a clone of Green House with it's simple and eye-cathcing UI."
            }
            deploy={"https://elaborate-brigadeiros-9edad5.netlify.app/"}
